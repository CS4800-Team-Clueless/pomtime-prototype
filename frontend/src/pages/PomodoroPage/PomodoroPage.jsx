...
const PomodoroPage = () => {
  ...
  const handleSessionComplete = async () => {
    ...
    if (currentSessionType === 'work') {
      try {
        const response = await fetchWithAuth(`${API_URL}/api/pomodoro/complete`, {
          method: 'POST',
          body: JSON.stringify({
        ...
        if (response.ok) {
          ...
          if (sessionsSinceBreak >= 3) { // 4th session complete
            switchToLongBreak();
          } else {
            switchToBreak();
          }
      ...
      <div className="pomodoro-container">
        ...
        <div className="pomodoro-header">
          <div className="stats-grid">
            <div className="stat-card">
              ...
              <div className="stat-label">Total Pom Prisms</div>
            </div>
          </div>
        </div>
        ...
        <div className="timer-section">
          <div className="session-type-selector">
            ...
            <button
              className={`type-btn ${sessionType === 'longBreak' ? 'active' : ''}`}
          ...
          <div className="timer-controls">
            ...
            <button className="control-btn settings-btn" onClick={() => setShowSettings(!showSettings)}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
